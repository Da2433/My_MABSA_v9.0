...
# from nn.linear import NonDynamicallyQuantizableLinear
from torch.nn.init import constant_, xavier_normal_, xavier_uniform_
from torch.nn.parameter import Parameter
from torch.nn import Module
import torch.nn.functional as F
from MultimodalBert.modules.transformer_mask_attention1 import multi_head_attention_forward
...
class MultiheadAttention_mask(Module):
    ...
    def __setstate__(self, state):
        ...
        super(MultiheadAttention_mask, self).__setstate__(state)
